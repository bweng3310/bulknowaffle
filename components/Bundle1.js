 ...
 useEffect(()=>{
  if(essential>0){
    settext({
      ...
      option1:`${eoption1}`,
      option2:`${eoption2} x ${essential*8}`,
      option3:`${eoption3} x ${essential*7}`,
      option4:`${eoption4} x ${essential*5}`,
      option5:`${eoption5} x ${essential*5}`,
      option6:`${eoption6} x ${essential*5}`,
      quant:essential*15
     })
     props.changebundle1set1(
      {
        summary:`Team Huddle Essential Set x ${essential} = ${parseFloat((essentialprice + plus1 + plus2 + plus3) * essential).toFixed(2)}`,
        bundle1set1:`Team Huddle Essential Set x ${essential}`,
        price:`$${parseFloat(essentialprice + plus1 + plus2 + plus3).toFixed(2)}`,
 ...
 useEffect(()=>{
  if(lattebar>0){
    settext2({
      ...
      option1:`* ${loption1}`,
      option2:`* ${loption2} x ${lattebar*8}`,
      option3:`* ${loption3} x ${lattebar*7}`,
      option4:`* ${loption4} x ${lattebar*5}`,
      option5:`* ${loption5} x ${lattebar*5}`,
      option6:`* ${loption6} x ${lattebar*5}`,
      quant:lattebar*15
 ...
 useEffect(()=>{
  if(tea>0){
    settext3({
      ...
      option1:`* ${toption1}`,
      option2:`* ${toption2} x ${tea*8}`,
      option3:`* ${toption3} x ${tea*7}`,
      option4:`* ${toption4} x ${tea*5}`,
      option5:`* ${toption5} x ${tea*5}`,
      option6:`* ${toption6} x ${tea*5}`,
      quant:tea*15
     })
 ...
 useEffect(()=>{
  if(mixed>0){
    settext4({
      ...
      option1:`* ${moption1}`,
      option2:`* ${moption2} x ${mixed*3}`,
      option3:`* ${moption3} x ${mixed*2}`,
      option4:`* ${moption4} x ${mixed*3}`,
      option5:`* ${moption5} x ${mixed*2}`,
      option6:`* ${moption6} x ${mixed*3}`,
      option7:`* ${moption7} x ${mixed*2}`,
      option8:`* ${moption8} x ${mixed*5}`,
      option9:`* ${moption9} x ${mixed*5}`,
      option10:`* ${moption10} x ${mixed*5}`,
      quant:mixed*15
          ...
          <h2 className="accordion-header" id={props.accordion3}>
            ...
            >
              ...
              <div className="d-flex flex-column col-8  justify-content-between">
                <div>Team Huddle 15 Drinks + 15 Snacks </div>
              </div>
            </button>
          </h2>
          <div
                ...
                <div className="mt-3 col-11 mx-auto ">
                  <div className="d-flex flex-column col-11 mt-3">
                    ...
                    <div className="d-flex flex-row align-items-center justify-content-between">
                      ...
                      <div className="m-3 col-4"> x 7</div>
                    </div>
                  ...
                  <div className="d-flex flex-column col-11 mt-5">
                    ...
                    <div className="d-flex flex-row align-items-center justify-content-between">
                      ...
                      <div className="m-3 col-4"> x 3</div>
                    </div>
                    <div className="d-flex flex-row align-items-center justify-content-between">
                      <select
                        name="entry.1148949922"
                      ...
                      <div className="m-3 col-4"> x 2</div>
                    </div>
                    <div className="d-flex flex-row align-items-center justify-content-between">
                      <select
                        name="entry.1148949922"
